/* http://forum.arduinoturkiye.com/index.php?p=/discussion/6395/artimsal-enkoder-ile-uzunluk-oelcuemue/p1
   ...
   Dr.TRonik YouTube/ www.ronaer.com tarafından  uyarlanmıştır...
*/
...
void loop()
{
  ...
  if (sonPulse != ilkPulse)
  {
    ...
    uzunluk = sonPulse * hesap; // Elde edilen pulse ile hesaplanan 1 pulse uzunluğunu çarpılıyor.
    ...
    lcd.setCursor(7, 1);
    lcd.print(uzunluk) + lcd.print("mm");
  }
}
